...
RULES: list[Rule] = [
    ...
    Rule(
        ...
        check_action_template="Пройти онбординг руками от регистрации до первого шага активации.",
        do_not_action_template="Не трогать рекламу -- проблема не в трафике, а в продукте.",
    ...
    Rule(
        ...
        do_not_action_template="Не трогать рекламу и онбординг до первого шага -- они работают.",
