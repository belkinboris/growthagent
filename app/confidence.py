...
# Числа общие для всей платформы (app/readiness.py): «мало данных» в сигнале
# и «мало данных» в сравнении недель должны означать одно и то же, иначе про
# одни и те же события экраны говорят разное.
_CONVERSION_THRESHOLDS = {
    "low": MIN_FOR_A_TREND,               # одна случайность может всё исказить
    "medium": ENOUGH_FOR_A_CONCLUSION,    # сигнал есть, но выборка небольшая
}
